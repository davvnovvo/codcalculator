...
public class ResearchFragment extends Fragment {
    ...
    ImageView research_image;
    TextView research_image_label, research_total;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.speedups_research_fragment, container, false);

        research_image = rootView.findViewById(R.id.research_image_view);
        research_image_label = rootView.findViewById(R.id.research_image_label);
        ImageButton add_image = rootView.findViewById(R.id.research_add_image_button);
        ImageButton reset = rootView.findViewById(R.id.research_reset_fields);
        research_total = rootView.findViewById(R.id.research_total);
        ImageButton calculate = rootView.findViewById(R.id.research_calculate);

        TextInputEditText[] fields = new TextInputEditText[] {
                rootView.findViewById(R.id.research_field_1min),
                rootView.findViewById(R.id.research_field_5min),
                rootView.findViewById(R.id.research_field_10min),
                rootView.findViewById(R.id.research_field_15min),
                rootView.findViewById(R.id.research_field_30min),
                rootView.findViewById(R.id.research_field_60min),
                rootView.findViewById(R.id.research_field_3h),
                rootView.findViewById(R.id.research_field_8h),
                rootView.findViewById(R.id.research_field_15h),
                rootView.findViewById(R.id.research_field_24h),
                rootView.findViewById(R.id.research_field_3_days),
                rootView.findViewById(R.id.research_field_7_days),
                rootView.findViewById(R.id.research_field_30_days)
        };

        fieldIds = new int[] {R.id.research_field_1min, R.id.research_field_5min, R.id.research_field_10min, R.id.research_field_15min, R.id.research_field_30min, R.id.research_field_60min, R.id.research_field_3h, R.id.research_field_8h, R.id.research_field_15h, R.id.research_field_24h, R.id.research_field_3_days, R.id.research_field_7_days, R.id.research_field_30_days};
        ...
        ImageButton remove_image = rootView.findViewById(R.id.research_remove_image_button);
        remove_image.setOnClickListener(v -> {
            research_image.setImageResource(0);
            research_image_label.setVisibility(View.VISIBLE);
        });
        ...
        research_total.setText(SharedPreferencesUtil.getCalculation(getContext(), "research"));
        calculate.setOnClickListener(v -> {
            ...
            SharedPreferencesUtil.saveCalculation(getContext(), "research", formattedTotal);
            research_total.setText(formattedTotal);
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                research_image.setImageBitmap(bitmap);
                research_image_label.setVisibility(View.GONE);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
