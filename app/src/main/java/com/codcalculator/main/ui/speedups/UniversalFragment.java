...
public class UniversalFragment extends Fragment {
    ...
    ImageView universal_image;
    TextView universal_image_label, universal_total;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.speedups_universal_fragment, container, false);

        universal_image = rootView.findViewById(R.id.universal_image_view);
        universal_image_label = rootView.findViewById(R.id.universal_image_label);
        ImageButton add_image = rootView.findViewById(R.id.universal_add_image_button);
        ImageButton reset = rootView.findViewById(R.id.universal_reset_fields);
        universal_total = rootView.findViewById(R.id.universal_total);
        ImageButton calculate = rootView.findViewById(R.id.universal_calculate);

        TextInputEditText[] fields = new TextInputEditText[] {
                rootView.findViewById(R.id.universal_field_1min),
                rootView.findViewById(R.id.universal_field_5min),
                rootView.findViewById(R.id.universal_field_10min),
                rootView.findViewById(R.id.universal_field_15min),
                rootView.findViewById(R.id.universal_field_30min),
                rootView.findViewById(R.id.universal_field_60min),
                rootView.findViewById(R.id.universal_field_3h),
                rootView.findViewById(R.id.universal_field_8h),
                rootView.findViewById(R.id.universal_field_15h),
                rootView.findViewById(R.id.universal_field_24h),
                rootView.findViewById(R.id.universal_field_3_days),
                rootView.findViewById(R.id.universal_field_7_days),
                rootView.findViewById(R.id.universal_field_30_days)
        };

        fieldIds = new int[] {R.id.universal_field_1min, R.id.universal_field_5min, R.id.universal_field_10min, R.id.universal_field_15min, R.id.universal_field_30min, R.id.universal_field_60min, R.id.universal_field_3h, R.id.universal_field_8h, R.id.universal_field_15h, R.id.universal_field_24h, R.id.universal_field_3_days, R.id.universal_field_7_days, R.id.universal_field_30_days};
        ...
        ImageButton remove_image = rootView.findViewById(R.id.universal_remove_image_button);
        remove_image.setOnClickListener(v -> {
            universal_image.setImageResource(0);
            universal_image_label.setVisibility(View.VISIBLE);
        });
        ...
        universal_total.setText(SharedPreferencesUtil.getCalculation(getContext(), "universal"));
        calculate.setOnClickListener(v -> {
            ...
            SharedPreferencesUtil.saveCalculation(getContext(), "universal", formattedTotal);
            universal_total.setText(formattedTotal);
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                universal_image.setImageBitmap(bitmap);
                universal_image_label.setVisibility(View.GONE);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
